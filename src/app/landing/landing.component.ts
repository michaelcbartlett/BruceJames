...
export class LandingComponent {
  ...
  handleDownloadWindowsClick() {
      ...
      setTimeout(() => {
        window.location.href = 'https://f005.backblazeb2.com/file/BruceJames-Marco/Marco_v1_1_8_Windows.zip';
      }, 300);
  ...
  handleDownloadmacOSClick() {
    if (typeof window !== 'undefined' && Array.isArray((window as any).dataLayer)) {
      ...
      setTimeout(() => {
        window.location.href = 'https://f005.backblazeb2.com/file/BruceJames-Marco/Marco_v1_1_8_macOS.zip';
      }, 300);
  }
}
